...
goog.provide('Blockly.Blocks.Pearl');

goog.require('Blockly.Blocks');


Blockly.Blocks['project_pearl'] = {
  helpUrl: 'http://github.com/wearableproject',
  init: function() {
    this.setColour(190);
    this.appendDummyInput()
  .appendField("PearlBoard")
  .appendField("Change # LEDs")
        .appendField(new Blockly.FieldDropdown([1,2,3,4,5,6]), "Number")
    this.appendDummyInput("COLOR0")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("Color 1")
        .appendField(new Blockly.FieldColour("#00ff00"), "RGB0");
    this.setMutator(new Blockly.Mutator(['project_pearl_number_item']));
